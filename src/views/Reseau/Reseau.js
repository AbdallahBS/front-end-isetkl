...
import ProfilePageHeader from "components/Headers/Reseau.js";
import DemoFooter from "components/Footers/DemoFooter.js";
import { getFile } from "actions/File.action";
import { getAllReseauFiles } from "actions";
...
function ProfilePage() {
  ...
  useEffect(()=>{
    dispatch(getReseau());
    dispatch(getAllReseauFiles())
    
  },[]);
  const Files = useSelector(state => state.File_Reseau);
 ...
 dispatch(getFile(form));
}
  if(Reseau.Reseau && Files.Files)
  return (
    <>
      <ExamplesNavbar />
      <ProfilePageHeader />
      <div className="section profile-content">
        <Container>
          <div className="owner">
            ...
            <div className="name">
              <h4 className="title">
               {Reseau.Reseau?Reseau.Reseau.reseau[0].name:null}<br />
              </h4>
